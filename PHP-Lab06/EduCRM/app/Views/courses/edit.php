...
?>
<div class="page-head"><h1>Sửa khóa học</h1><a href="/courses" class="btn btn-ghost">&laquo; Quay lại</a></div>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <div class="course-preview" id="coursePreview">
                    <?php if ($curImage !== ''): ?><img src="/assets/img/courses/<?= e($curImage) ?>" alt="preview"><?php else: ?><span class="muted">Chưa chọn ảnh</span><?php endif; ?>
                </div>
            </div>
            <div class="form-group full">
                <label for="description">Giới thiệu khóa học</label>
                <textarea id="description" name="description" rows="3" placeholder="Đoạn văn giới thiệu: khóa này dành cho ai, học gì, đạt được gì..."><?= e($curDesc) ?></textarea>
