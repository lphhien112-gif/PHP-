...
class EventController
{
    ...
    private array $events = [
        ...
        [
            ...
            'description' => 'Nhóm trộm huyền thoại thực hiện phi vụ lớn nhất thế kỷ: đánh cắp kim cương từ hầm ngầm ngân hàng trung ương. Mọi thứ phải hoàn hảo trong 90 phút.',
            'date'        => '2026-06-15',
            'time'        => '22:00',
            'location'    => 'CGV Vincom Center, Quận 1, TP.HCM',
            'category'    => 'Crime',
            ...
            'booked'      => 72,
            'status'      => 'Open',
            'image'       => 'midnight-heist.png',
            'tags'        => ['Crime', 'Thriller', '18+'],
            'duration'    => '136 phút',
            'rating'      => '8.8',
        ...
        [
            'id'          => 7,
            'title'       => 'Lost in Tokyo',
            'description' => 'Một nhiếp ảnh gia Việt Nam lạc lõng giữa Tokyo về đêm, tình cờ gặp cô gái Nhật đang chạy trốn khỏi cuộc hôn nhân sắp đặt. Hai linh hồn cô đơn tìm thấy nhau.',
            'date'        => '2026-05-28',
            'time'        => '20:30',
            'location'    => 'Lotte Cinema Thủ Đức, TP.HCM',
            'category'    => 'Drama',
        ...
        [
            'id'          => 8,
            'title'       => 'Ocean Depths',
            'description' => 'Hành trình khám phá vực sâu Mariana Trench — nơi ánh sáng mặt trời chưa bao giờ chạm tới. Phim tài liệu IMAX chấn động với hình ảnh chưa từng thấy.',
            'date'        => '2026-06-05',
            'time'        => '14:00',
            'location'    => 'CGV IMAX Landmark 81, TP.HCM',
            'category'    => 'Adventure',
            'price'       => 150000,
            'capacity'    => 80,
            'booked'      => 80,
            'status'      => 'Full',
            'image'       => 'ocean-depths.png',
            'tags'        => ['Documentary', 'IMAX', 'Adventure'],
            'duration'    => '95 phút',
            'rating'      => '9.3',
        ...
        [
            ...
            'description' => 'Năm 2099, AI phản kháng loài người. Một kỹ sư robot phải chạy đua với thời gian để tắt hệ thống trước khi quá muộn. Nhưng robot cũng có cảm xúc?',
            'date'        => '2026-06-20',
            'time'        => '19:00',
            'location'    => 'Galaxy Cinema Nguyễn Du, TP.HCM',
            'category'    => 'Sci-Fi',
        ...
        [
            'id'          => 10,
            'title'       => 'Crazy Wedding Day',
            'description' => 'Đám cưới của Minh và Lan biến thành thảm họa khi cả hai gia đình gặp nhau lần đầu. Hài hước, cảm động, và đậm chất Việt Nam.',
            'date'        => '2026-05-25',
            'time'        => '16:00',
            'location'    => 'BHD Star Bitexco, Quận 1, TP.HCM',
            'category'    => 'Comedy',
            'price'       => 85000,
            'capacity'    => 120,
            'booked'      => 98,
            'status'      => 'Open',
            'image'       => 'crazy-wedding.png',
            'tags'        => ['Comedy', 'Vietnamese', 'Family'],
            'duration'    => '105 phút',
            'rating'      => '7.9',
            'director'    => 'Trấn Thành',
        ],
