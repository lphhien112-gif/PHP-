...
\begin{tikzpicture}[remember picture, overlay]
    % Outer frame
    \draw[line width=3pt, blue!70!black] 
        ([shift={(1cm,1cm)}]current page.south west) rectangle 
        ([shift={(-1cm,-1cm)}]current page.north east);
    % Inner frame
    \draw[line width=1pt, blue!70!black] 
        ([shift={(1.25cm,1.25cm)}]current page.south west) rectangle 
        ([shift={(-1.25cm,-1.25cm)}]current page.north east);
\end{tikzpicture}
...
{\fontsize{14}{16}\selectfont \textbf{ĐẠI HỌC QUỐC GIA THÀNH PHỐ HỒ CHÍ MINH}}\\[4pt]
{\fontsize{14}{16}\selectfont \textbf{TRƯỜNG ĐẠI HỌC KHOA HỌC TỰ NHIÊN}}\\[4pt]
{\fontsize{13}{15}\selectfont \textbf{KHOA TOÁN --- TIN HỌC}}

\vspace{6pt}
{\color{blue!70!black}\rule{8cm}{1.5pt}}

\vspace{2.5cm}

{\fontsize{24}{28}\selectfont \textbf{BÁO CÁO THỰC HÀNH}}

\vspace{10pt}

{\fontsize{16}{20}\selectfont \textbf{Lab02: PHP GET, POST, HEAD, OPTIONS}}

\vspace{15pt}

{\color{blue!70!black}\rule{6cm}{0.8pt}}

\vspace{15pt}

{\fontsize{14}{17}\selectfont \textit{Ứng dụng: \textbf{CineHub — Đặt Vé Xem Phim Online}}}

\vspace{3cm}

\begin{tabular}{ll}
    \textbf{Giảng viên hướng dẫn:} & TS. Trần Anh Tuấn \\[4pt]
    \textbf{Môn học:} & Lập trình Web \\[4pt]
    \textbf{Sinh viên thực hiện:} & Lê Phạm Hồng Hiên \\[4pt]
    \textbf{MSSV:} & 22110059 \\[4pt]
\end{tabular}

\vfill

{\color{blue!70!black}\rule{5cm}{0.8pt}}
